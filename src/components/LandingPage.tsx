...
const navigation = [
  {
    name: "About US",
    href: "https://ayiera-initiative.org/2017/11/13/sport-for-social-change-in-korogocho-slum/",
  },
  {
    name: "Empowerment Programs",
    href: "https://ayiera-initiative.org/2017/11/13/sport-for-social-change-in-korogocho-slum/",
  },
  { name: "News & Updates", href: "https://ayiera-initiative.org/news/" },
  {
    name: "Donate",
    href: "https://www.paypal.com/donate/?hosted_button_id=YK2DEBBY9SV8G",
  },
];
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-40">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              <a
                href="https://ayiera-initiative.org/supporters/"
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Empowering Talent and Communities for Positive Social Change
            </h1>
